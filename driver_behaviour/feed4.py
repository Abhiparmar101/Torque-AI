...
def infer(args):
    ...
    video_path = "rtmp://ptz.vmukti.com:80/live-record/SSAM-160707-EADBE"
    cam_id = args.webcam
    checkpoint = "models/model_split.h5"
    save = args.save
    ...
    if video_path or cam_id is not None:
        ...
        rtmp_url = "rtmp://ptz.vmukti.com:80/live-record/PNJB-000173-PBPTZ-AI"
        ffmpeg = "ffmpeg -f rawvideo -pix_fmt bgr24 -s {}x{} -r 20 -i - -c:v libx264 -preset ultrafast -f flv {}".format(frame_width, frame_height, rtmp_url)
...
if __name__ == '__main__':
    ...
    p.add_argument('--webcam', type=str, default=None, help='Cam ID')
