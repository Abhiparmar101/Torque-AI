...
def feed1():
    ...
    rtmp_url = "rtmp://64.227.188.130:1935/live/feed1"
    ...
    model_detection = torch.hub.load("ultralytics/yolov5", "custom", path = "/home/torqueai/github/Torque-AI/ffmpegfeed/yolov5s.pt",device='cpu', force_reload=True)
