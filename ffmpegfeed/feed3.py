...
def feed3():
    ...
    video_cap = cv2.VideoCapture("rtmp://ptz.vmukti.com:80/live-record/SSAM-160711-BACBC") # number of the webcam, here the first
    ...
    model_detection = torch.hub.load("ultralytics/yolov5", "custom", path = "/home/torqueai/github/Torque-AI/ffmpegfeed/crowdhuman_yolov5m.pt",device='cpu', force_reload=True)
