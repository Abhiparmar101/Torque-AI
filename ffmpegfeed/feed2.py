...
def feed2():
    ...
    rtmp_url = "rtmp://64.227.188.130:1935/live/feed2"
    ...
    model_detection = torch.hub.load("ultralytics/yolov5", "custom", path = "/home/torqueai/github/Torque-AI/Fire_detection/fire.pt",device='cpu', force_reload=True)
